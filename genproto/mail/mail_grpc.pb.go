...
const (
	MailService_SendMail_FullMethodName    = "/mail.MailService/SendMail"
	MailService_NewSendMail_FullMethodName = "/mail.MailService/NewSendMail"
)
...
type MailServiceClient interface {
	...
	NewSendMail(ctx context.Context, in *NewMailRequest, opts ...grpc.CallOption) (*MailResponse, error)
}
...
func (c *mailServiceClient) NewSendMail(ctx context.Context, in *NewMailRequest, opts ...grpc.CallOption) (*MailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MailResponse)
	err := c.cc.Invoke(ctx, MailService_NewSendMail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MailServiceServer interface {
	...
	NewSendMail(context.Context, *NewMailRequest) (*MailResponse, error)
...
func (UnimplementedMailServiceServer) NewSendMail(context.Context, *NewMailRequest) (*MailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NewSendMail not implemented")
}
...
func _MailService_NewSendMail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewMailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MailServiceServer).NewSendMail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MailService_NewSendMail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MailServiceServer).NewSendMail(ctx, req.(*NewMailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MailService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NewSendMail",
			Handler:    _MailService_NewSendMail_Handler,
		},
	},
